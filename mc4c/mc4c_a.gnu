load '../tino/piyg.pal'
fdx=0; ldx=1; mdx=4
fx(cdx) = sprintf("%s_CTCF/N128-F%d-L%d-M%d-r0.P_fit.vm",cdx==0 ? 'Hap1' : 'WaplKO', fdx,ldx,mdx)
N  = 128
rs = 0.01
gz = 120.8
...
set cbrange [-2.4:-1.]; set cbtics -5,1,0 in scale 0.5; set mcbtics 5
do for [i=-3:0:1] {
