...
plot fx u 0:($5> 0.8? $5 : NaN):6:xticlabels(1) w error lw mlw lc rgb 'red'  pt 7 ps mps notitle, \
     fx u 0:($5<=0.8? $5 : NaN):6:xticlabels(1) w error lw mlw lc rgb 'blue' pt 7 ps mps notitle
